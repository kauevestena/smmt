...
out.precision(20);
    ...
    ptsOnPlanes.raw_print(out,"La:");out<<endl;
...
string line;
    ...
    res.push_back(A);res.push_back(B);res.push_back(C);res.push_back(D);res.push_back(E);
...
TptMat(&ptsH,-imuC);TptMat(&ptsV,-imuC);
translateAll(-imuC);
...
RptMat(&ptsH,Rot1);RptMat(&ptsV,Rot1);
rotAll(Rot1);
